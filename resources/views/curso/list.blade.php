...
<form action="{{ route('curso.search') }}" method="post">
    ...
    <div class="row">
        ...
        <div class="col-4" style="margin-top: 22px;">
            ...
            <a href="{{ url('curso/create') }}" class="btn btn-success"><i class="fa-solid fa-plus"></i> Novo</a>
        </div>
    </div>
</form>
    ...
    <tbody>
        @foreach ($dados as $item)
            <tr>
                ...
                <td><a href="{{ route('curso.edit', $item->id) }} "class="btn btn-outline-primary" title="Editar"><i
                            class="fa-solid fa-pen-to-square"></i></a></td>
                <td>
                    <form action="{{ route('curso.destroy', $item) }}" method="post">
                        @method('DELETE')
                        @csrf
