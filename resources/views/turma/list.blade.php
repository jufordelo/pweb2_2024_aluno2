...
<form action="{{ route('turma.search') }}" method="post">
    ...
    <div class="row">
        ...
        <div class="col-4" style="margin-top: 22px;">
            ...
            <a href="{{ url('turma/create') }}" class="btn btn-success"><i class="fa-solid fa-plus"></i> Novo</a>
        </div>
    </div>
</form>
    ...
    <tbody>
        @foreach ($dados as $item)
            <tr>
                ...
                <td><a href="{{ route('turma.edit', $item->id) }} "class="btn btn-outline-primary" title="Editar"><i
                            class="fa-solid fa-pen-to-square"></i></a></td>
                <td>
                    <form action="{{ route('turma.destroy', $item) }}" method="post">
                        @method('DELETE')
                        @csrf
