        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    ...
                    name="remember">
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Lembrar-me')); ?></span>
            </label>
        </div>

        <div class="flex items-center justify-end mt-4">
            <a class="rounded-full text-black bg-blue-500" href="<?php echo e(route('register')); ?>">
